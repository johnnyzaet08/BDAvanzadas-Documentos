function searchData () {
    ...
    socket.emit('requestsAPI/InternationalTravels', trimestre, ano);
}
...
socket.on('internationalRequestFront', (data) => {
    var formContainer = document.getElementById("form-container");
    if(data == "Error"){
        ...
        try{
            ...
            if(data.length > 0){
                ...
                ["Nombre completo", "País de destino"].forEach(function(headerText) {
